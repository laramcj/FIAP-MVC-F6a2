...
public class Banco {
   ...
   private static Integer chaveSequencial = 1;
	...
	static {
		...
		entretenimento1.setDescricao("Theatro Municipal, 110 anos de história só fazem sentido com você na plateia.");
		entretenimento1.setLocalizacao("Praça Ramos de Azevedo, s/n - República, São Paulo - SP");
		entretenimento1.setHorarioFuncionamento("Das 10h às 19h");
		...
		entretenimento2.setDescricao("O Bixiga é entendido como um dos mais tradicionais bairros da cidade de São Paulo, embora na divisão administrativa da cidade ele não exista oficialmente como tal.");
		entretenimento2.setLocalizacao("Bairro Bixiga, São Paulo - SP");
		...
		entretenimento3.setNome("Praça Benedito Calixto");
		entretenimento3.setId(chaveSequencial++);
		entretenimento3.setDescricao("A Praça Benedito Calixto em Pinheiros é um importante polo cultural da cidade.");
		entretenimento3.setLocalizacao("Praça Benedito Calixto - Pinheiros, São Paulo - SP");
		...
		entretenimento4.setNome("Autódromo de Interlagos");
		entretenimento4.setId(chaveSequencial++);
		entretenimento4.setDescricao("Autódromo José Carlos Pace é um autódromo municipal localizado no distrito de Cidade Dutra, na cidade de São Paulo, Brasil. Pela proximidade com o bairro de Interlagos é popularmente chamado de Autódromo de Interlagos.");
		entretenimento4.setLocalizacao("Av. Sen. Teotônio Vilela, 261 - Interlagos, São Paulo - SP,");
		...
		entretenimento5.setDescricao("O Escape 60 é uma nova forma de entretenimento inteligente, agradável e diferente, voltada para famílias, amigos e equipes de trabalho.");
		entretenimento5.setLocalizacao("Rua Henrique Schaumann, 717 - Pinheiros, São Paulo - SP");
		entretenimento5.setHorarioFuncionamento("Das 10h às 22h");
